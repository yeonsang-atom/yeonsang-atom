...
### C Language Compiler (Mini C Compiler)  
- Implemented a mini C compiler using Lex & Yacc
- Built lexical, syntax, and semantic analysis phases
- Constructed AST for structured parsing
- Supported declarations, expressions, and control statements

👉 https://github.com/yeonsang-atom/c-compiler-mini.git
